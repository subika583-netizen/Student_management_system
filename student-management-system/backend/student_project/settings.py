...
Generated for College Student Management System CRUD Project.
"""
...
MIDDLEWARE = [
    # CORS middleware must be at the very top of the list
...
# Database
# Using SQLite for zero-configuration, persistent local storage
DATABASES = {
    'default': {
...
# CORS Configuration
# Allowed origins for React development server and local clients
